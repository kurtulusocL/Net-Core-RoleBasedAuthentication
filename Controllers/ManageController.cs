...
using RoleBasedAuthentication.Core.Utilities.Extensions;
...
namespace RoleBasedAuthentication.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IEmailSender emailSender,
          ILogger<ManageController> logger, UrlEncoder urlEncoder)
        {
        ...
        public async Task<IActionResult> Index(IndexDto model)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> SendVerificationEmail(IndexDto model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
